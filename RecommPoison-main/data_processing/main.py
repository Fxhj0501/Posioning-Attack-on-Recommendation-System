...
if __name__ == '__main__':
    ...
    training_ratings.to_csv("/root/autodl-tmp/RecommPoison-main/attacks/Data"+'/train.csv',index=None)
    evaluate_ratings.to_csv("/root/autodl-tmp/RecommPoison-main/attacks/Data"+'/evaluate.csv',index=None)
    evaluate_negative_samples.to_csv("/root/autodl-tmp/RecommPoison-main/attacks/Data"+'/evaluate_negative_samples.csv',index=None)

    statistics=training_ratings.itemId.value_counts()
    statistics.to_csv("/root/autodl-tmp/RecommPoison-main/attacks/Data"+'/statistics.csv')
