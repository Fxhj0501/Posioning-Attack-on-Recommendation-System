...
#     train_data = pd.read_csv("/root/autodl-tmp/neural_collaborative_filtering-master/Data/ml-1m.train.rating",
...
#     '''
#     test_data = []
#     with open("/root/autodl-tmp/neural_collaborative_filtering-master/Data/ml-1m.test.negative", 'r') as fd:
#         line = fd.readline()
